    ...
    leerDatosProducto(producto){
        ...
        if(productosLS === infoProducto.id){
            Swal.fire({
                type: 'error',
                title: 'OMG!!',
                text: 'El producto ya está agregado, procesa al pago porfavor',
            ...
            Swal.fire({
                ...
                text: 'Revisa tu carrito para encontrar este producto',
    ...
    vaciarLocalStorage(){
        if (this.obtenerProductosLocalStorage().length === 0) {
            Swal.fire({
                ...
                text: 'Porfavor selecciona productos de nuestra tienda',
                showConfirmButton: true,
                timer: 5000
            })
        }else{
            Swal.fire({
                type: 'info',
                title: 'Se han eliminado los productos',
